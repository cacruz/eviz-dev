...
class PathsConfig:
    ...
    def __post_init__(self):
        object.__setattr__(self, 'meta_attrs_path', os.path.join(self.root_filepath, 'config', 'meta_attributes.yaml'))
        object.__setattr__(self, 'meta_coords_path', os.path.join(self.root_filepath, 'config', 'meta_coordinates.yaml'))
        object.__setattr__(self, 'species_db_path', os.path.join(self.root_filepath, 'config', 'species_database.yaml'))
