...
def test_get_default_yaml_path(model_name, expected):
    assert u.get_default_yaml_path(model_name) == expected


def test_get_nested_key_value_1nest():
...
def test_get_project_root():
    assert u.get_project_root().name == 'eviz' or u.get_project_root().name == 'eviz.git'
